...
namespace SilkCMS.Core;
        ...
        where TUserToken : UserToken, new()
    {
        ...
        public UserStore(ILiteDbContext dbContext)
        {
        ...
        public Task AddToRoleAsync(TUser user, string normalizedRoleName, CancellationToken cancellationToken)
        {
            ...
            _ = user ?? throw new ArgumentNullException(nameof(user));
            _ = normalizedRoleName ?? throw new ArgumentNullException(nameof(normalizedRoleName));
        ...
        public Task SetSecurityStampAsync(TUser user, string stamp, CancellationToken cancellationToken)
        {
            ...
            ThrowIfDisposed();
            _ = user ?? throw new ArgumentNullException(nameof(user));
            _ = stamp ?? throw new ArgumentNullException(nameof(stamp));
